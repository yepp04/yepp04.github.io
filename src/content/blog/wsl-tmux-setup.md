...
## Windows Terminal 먼저 깔자

WSL을 쓰기 전에 터미널부터 바꿔야 합니다. 기본 CMD나 PowerShell은 탭도 없고, 폰트도 별로고, 복사/붙여넣기도 불편합니다.

Microsoft Store에서 **Windows Terminal**을 설치하세요. 이미 설치되어 있을 수도 있습니다.
...
이제 Windows Terminal을 열면 바로 Ubuntu 쉘이 뜹니다. 탭으로 여러 터미널을 열 수 있고, `Ctrl+Shift+T`로 새 탭, `Ctrl+Shift+W`로 탭 닫기가 됩니다.
...
WSL2는 가상 디스크(VHDX)를 사용하는데, 한번 늘어난 디스크는 자동으로 줄어들지 않습니다.
