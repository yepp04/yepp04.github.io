...
설치가 끝났으면 PowerShell에서 WSL 버전을 확인합니다.
...
### 3단계: Windows Terminal 기본 프로필을 Ubuntu로 변경

버전 확인까지 끝났으면 이제 기본 쉘을 바꿔줍니다. 이후 과정은 모두 Ubuntu 쉘에서 진행합니다.
